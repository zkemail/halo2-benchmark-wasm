...
* @returns {any}
*/
export function prove_simple_circuit(params_ser) {
...
* @returns {any}
*/
export function prove_scalar_mult(params_ser) {
...
* @returns {any}
*/
export function prove_scalar_mult_full(params_ser) {
...
async function init(input, maybe_memory) {
    if (typeof input === 'undefined') {
        input = new URL('halo2_efficient_ecdsa_bg.wasm', import.meta.url);
    }
    const imports = getImports();
